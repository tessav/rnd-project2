...
Inverse position kinematics problem: joint 1, 2, 3 determine the position of the end effector. <br>
Inverse orientation kinematics problem: joint 4, 5, 6 forms a spherical wrist that determines the orientation of the end effector. <br> 
